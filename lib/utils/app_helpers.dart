...
class AppHelpers {
  ...
  static String getPackageImage({required String packageType}) {
    if (packageType == "battery") {
      return batteryPNG;
    }
    if (packageType == "inverter") {
      return inverterPNG;
    }
    if (packageType == "charger") {
      return chargeControllerPNG;
    }
    if (packageType == "panel") {
      return solarPanelPNG;
    }
    return '';
  }
